...
/**
 * Data representation on data base<br>
 * <br>
...
public class Data
{
   ...
   private void checkType(final DataType dataType)
   {
      ...
      {
         throw new IllegalStateException(UtilText.concatenate("The data is ", this.dataType.name(), " not ", dataType.name()));
      }
   }
   ...
   /**
    * Value on {@link java.lang.Object}
    * 
    * @return Value
    */
   ...
   /**
    * Value on {@link java.sql.Timestamp}
    * 
    * @return Value
    */
   ...
   /**
    * Change {@link java.sql.Date} value
    * 
    * @param value
    *           New value
    */
   ...
   /**
    * Change {@link java.lang.Object} value
    * 
    * @param value
    *           New value
    */
   ...
   /**
    * Change {@link java.sql.Time} value
    * 
    * @param value
    *           New value
    */
   ...
   /**
    * Change {@link java.sql.Timestamp} value
    * 
    * @param value
    *           New value
    */
