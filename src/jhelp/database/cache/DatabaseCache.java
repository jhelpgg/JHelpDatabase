...
public class DatabaseCache
{
   ...
   static
   {
      ...
      selectQuery.setWhere(new ConditionColumnEquals(DatabaseCache.TABLE_CACHE_COLUM_NAME, DatabaseCache.DATA_KEY_NAME));
      SELECT_QUERY_VALUE = selectQuery;

      DATA_VALUE = Data.createLongStringData("");

      final UpdateQuery updateQuery = new UpdateQuery(DatabaseCache.TABLE_CACHE, new Value(DatabaseCache.TABLE_CACHE_COLUM_VALUE, DatabaseCache.DATA_VALUE));
      updateQuery.setWhere(new ConditionColumnEquals(DatabaseCache.TABLE_CACHE_COLUM_NAME, DatabaseCache.DATA_KEY_NAME));
    ...
    *            On creation/access database issue
    */
    ...
    * @param password
    *           Password to use. On creation it defines the password, other times it is use to check authorization
    * @throws DatabaseException
    *            On creation/access database issue
    */
    ...
    * 
    * @param value
    *           Element to change with new value
    * @throws DatabaseException
    *            On changing issue
    */
   ...
   private ValueCache obtainValue(final String key) throws DatabaseException
   {
      ...
      final Type type = Type.valueOf(queryResult.getData(queryResult.getColumnIndex(DatabaseCache.TABLE_CACHE_COLUM_TYPE), 0).getLongString());
      final String value = queryResult.getData(queryResult.getColumnIndex(DatabaseCache.TABLE_CACHE_COLUM_VALUE), 0).getLongString();
    ...
    *           Key of the value
    * @param defaultValue
    *           Value to use if key dosen't exists
    * @return Element value or deafultValue if key not exists
    * @throws DatabaseException
    *            On reading database issue
    */
