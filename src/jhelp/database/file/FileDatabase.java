...
{
   /**
    * Thread to fill automatically with all files on the computer <br>
    * <br>
            ...
            else
            {
               try
               {
                  ...
                  if(path.indexOf('\'') >= 0)
                  {
                     ...
                     file = f;
                     Debug.println(DebugLevel.VERBOSE, "REANAME : ", file.getAbsolutePath());
                  }
    ...
    * 
    * @param path
    *           Relative data base path
    * @throws DatabaseException
    *            On data base connection problem
    */
   ...
   public int addWord(String word) throws DatabaseException
   {
      if(word == null)
      {
         throw new NullPointerException("word musn't be null");
      }
      word = word.trim();
      if(word.length() == 0)
      {
         throw new IllegalArgumentException("word musn't be empty");
      }
   ...
   public void associate(final File file, final String... words) throws DatabaseException
   {
      if(words == null)
      {
         throw new NullPointerException("words musn't be null");
      }
   ...
   public void deleteFile(final File file) throws DatabaseException
   {
      ...
      selectQuery.setWhere(new ConditionColumnEquals(FileDatabase.COLUMN_PATH.getColumnName(), Data.createLongStringData(path)));
      ...
      if(queryResult.numberOfRows() > 0)
      {
         ...
         this.database.delete(FileDatabase.ASSOCIATIONS, new ConditionColumnEquals(FileDatabase.COLUMN_FILE_ID.getColumnName(), fileID));
         ...
         this.database.delete(FileDatabase.WORDS, new ConditionNOT(new ConditionIN(FileDatabase.COLUMN_ID.getColumnName(), selectQuery)));

         // Delete the file from FILES table
         this.database.delete(FileDatabase.FILES, new ConditionColumnEquals(FileDatabase.COLUMN_ID.getColumnName(), fileID));
    ...
    *           Word to delete
    * @throws DatabaseException
    *            On database reading/writing problem or if the word is not in data base
    */
   public void deleteWord(final String word) throws DatabaseException
   {
      ...
      this.database.delete(FileDatabase.ASSOCIATIONS, new ConditionColumnEquals(FileDatabase.COLUMN_WORD_ID.getColumnName(), wordID));

      // Delete the word in WORDS table
      this.database.delete(FileDatabase.WORDS, new ConditionColumnEquals(FileDatabase.COLUMN_ID.getColumnName(), wordID));
   ...
   public File[] getFilterFiles(final String... filters) throws DatabaseException
   {
      ...
      if((filters != null) && (filters.length > 0))
      {
         ...
         for(String filter : filters)
         {
            ...
            {
               where = new ConditionAND(where, new ConditionFileAssociation(ids.toArray()));
            }
   ...
   {
      SelectQuery selectQueryAssociatesFiles = new SelectQuery(FileDatabase.ASSOCIATIONS, FileDatabase.COLUMN_FILE_ID);

      SelectQuery selectQueryNotAssociates = new SelectQuery(FileDatabase.FILES, FileDatabase.COLUMN_PATH);
      selectQueryNotAssociates.setWhere(new ConditionNOT(new ConditionIN(FileDatabase.COLUMN_ID.getColumnName(), selectQueryAssociatesFiles)));
    ...
    *           New location
    * @throws DatabaseException
    *            On data base reading/writing problem or if old file is not in data base or new file is in data base or the
   ...
   public void renameFile(final File oldFile, final File newFile) throws DatabaseException
   {
      if(oldFile == null)
      {
         throw new NullPointerException("oldFile musn't be null");
      }
      if(newFile == null)
      {
         throw new NullPointerException("newFile musn't be null");
      }
      ...
      if(queryResult.numberOfRows() > 0)
      {
         ...
         throw new DatabaseException(UtilText.concatenate("The new file '", newFile.getAbsolutePath(), "' already exists"));
      }
      queryResult.destroy();
      ...
      if(queryResult.numberOfRows() == 0)
      {
         ...
         throw new DatabaseException(UtilText.concatenate("The old file '", oldFile.getAbsolutePath(), "' not exists"));
      }
      ...
      UpdateQuery updateQuery = new UpdateQuery(FileDatabase.ASSOCIATIONS, new Value(FileDatabase.COLUMN_FILE_ID.getColumnName(), newID));
      ...
      this.database.delete(FileDatabase.FILES, new ConditionColumnEquals(FileDatabase.COLUMN_ID.getColumnName(), oldID));
    ...
    *           New word
    * @throws DatabaseException
    *            On reading/writing data base problem or if old word not in data base
    */
   public void renameWord(final String oldWord, final String newWord) throws DatabaseException
   {
      if(oldWord == null)
      {
         throw new NullPointerException("oldWord musn't be null");
      }
      if(newWord == null)
      {
         throw new NullPointerException("newWord musn't be null");
      }
      ...
      // Change associations
      UpdateQuery updateQuery = new UpdateQuery(FileDatabase.ASSOCIATIONS, new Value(FileDatabase.COLUMN_WORD_ID.getColumnName(), newID));
      updateQuery.setWhere(new ConditionColumnEquals(FileDatabase.COLUMN_WORD_ID.getColumnName(), oldID));
      this.database.update(updateQuery);

      // Delete old word
      this.database.delete(FileDatabase.WORDS, new ConditionColumnEquals(FileDatabase.COLUMN_ID.getColumnName(), oldID));
